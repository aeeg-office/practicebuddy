    ...
    <Card className="border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
      <CardContent className="p-5">
        <div className="flex items-start justify-between">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[rgb(71,32,183)]/10 to-[rgb(30,39,97)]/10 text-[rgb(71,32,183)]">
        ...
        <p className="mt-3 text-2xl font-bold text-[rgb(30,39,97)]">{value}</p>
...
function QuickActionButton({
  ...
  return (
    ...
    >
      <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-[rgb(71,32,183)]/10 to-[rgb(30,39,97)]/10 text-[rgb(71,32,183)]">
        <Icon className="h-5 w-5" />
      </div>
      <span className="text-xs font-medium text-[rgb(30,39,97)] text-center leading-tight">
        {label}
      </span>
    </button>
  )
        ...
        <div className="flex h-16 items-center justify-between border-b border-gray-100 px-4">
          {sidebarOpen && (
            <Link href="/teacher" className="flex items-center gap-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-[rgb(71,32,183)] to-[rgb(30,39,97)] text-white text-sm font-bold">
                {sidebar.logo}
              </div>
              <div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-gray-200 bg-white/95 backdrop-blur-sm px-4 md:px-6 lg:px-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-lg font-semibold text-[rgb(30,39,97)] hidden sm:block">
                {dashboard.greeting} <span className="text-[rgb(71,32,183)]">{dashboard.instructorName}</span>
              </h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3 pl-2 border-l border-gray-200">
              <div className="hidden text-right sm:block">
                <p className="text-sm font-medium text-[rgb(30,39,97)] leading-tight">{topBar.instructorName}</p>
                <p className="text-[11px] text-gray-500">{topBar.instructorRole}</p>
              </div>
              <Avatar fallback="AK" size="md" className="ring-2 ring-[rgb(71,32,183)]/20" />
            </div>
          </div>
        </header>
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8 space-y-6">
          ...
          <section className="grid gap-6 xl:grid-cols-3">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="min-w-[110px] flex items-center gap-2">
                          <div className={`h-2 w-2 rounded-full shrink-0 ${
                            ...
                            item.status === "upcoming" ? "bg-[rgb(71,32,183)]" :
                            "bg-red-400"
                          }`} />
                          <p className="text-sm font-medium text-[rgb(30,39,97)]">
                            {item.time}
                          </p>
                        </div>
                        {/* Details */}
                        <div>
                          <p className="text-sm font-semibold text-[rgb(30,39,97)]">
                            {item.student}
                          </p>
            ...
            <div className="space-y-4">
              ...
              {/* Monthly Stats Card */}
              <Card className="border-0 bg-gradient-to-br from-[rgb(71,32,183)] to-[rgb(30,39,97)] text-white shadow-md">
                <CardContent className="p-5">
                  <div className="flex items-center gap-3">
          ...
          <section className="grid gap-6 xl:grid-cols-3">
            ...
            <div className="xl:col-span-2">
              <div className="mb-4 flex items-center justify-between">
                <div>
                  <h2 className="text-base font-semibold text-[rgb(30,39,97)] flex items-center gap-2">
                    <Users className="h-4 w-4 text-[rgb(71,32,183)]" />
                    {myStudents.title}
                  </h2>
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {(myStudents.items ?? []).map((student: { name: string; course: string; lastScore: string; nextSession: string; progress: number }, i: number) => (
                        <tr
                          key={i}
                          className="transition-colors hover:bg-[rgb(71,32,183)]/[0.02]"
                        >
                          <td className="px-5 py-4">
                            <div className="flex items-center gap-3">
                              <Avatar fallback={student.name} size="sm" className="ring-1 ring-gray-200" />
                              <span className="font-medium text-[rgb(30,39,97)]">
                                {student.name}
                              </span>
                            </div>
                          </td>
            ...
            <div>
              <div className="mb-4 flex items-center justify-between">
                <h2 className="text-base font-semibold text-[rgb(30,39,97)] flex items-center gap-2">
                  <Bell className="h-4 w-4 text-[rgb(71,32,183)]" />
                  ...
                  <div className="divide-y divide-gray-100">
                    {(recentActivity.items ?? []).map((item: { text: string; time: string }, i: number) => {
                      const activityColors = [
                        ...
                        "text-[rgb(71,32,183)] bg-[rgb(71,32,183)]/10",
                        "text-[rgb(245,166,35)] bg-[rgb(245,166,35)]/10",
                        "text-emerald-600 bg-emerald-100",
                        "text-[rgb(30,39,97)] bg-[rgb(30,39,97)]/10",
                      ]
                      ...
                      return (
                        <div key={i} className="flex items-start gap-3 px-5 py-4 hover:bg-gray-50/50 transition-colors">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-sm text-[rgb(30,39,97)] leading-snug">{item.text}</p>
              ...
              <Card className="mt-4 border border-gray-100 shadow-sm bg-gradient-to-br from-amber-50 to-orange-50">
                <CardContent className="p-5">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <h3 className="text-sm font-semibold text-[rgb(30,39,97)]">{aiTools.title}</h3>
          ...
          <section className="flex flex-col items-center justify-between gap-4 rounded-xl border border-gray-200 bg-white p-6 shadow-sm sm:flex-row">
            <div className="flex items-start gap-4">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[rgb(71,32,183)]/10 to-[rgb(30,39,97)]/10 text-[rgb(71,32,183)]">
                <FileText className="h-6 w-6" />
              </div>
              <div>
                <h3 className="text-base font-semibold text-[rgb(30,39,97)]">
