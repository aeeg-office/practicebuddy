...
const masteryConfig: Record<MasteryLevel, { label: string; variant: "default" | "secondary" | "accent" | "outline" | "success" | "destructive"; color: string }> = {
  ...
  developing: { label: "Developing", variant: "default", color: "text-[#4720b7] bg-[#4720b7]/10" },
...
const difficultyConfig: Record<Difficulty, { label: string; color: string }> = {
  ...
  medium: { label: "Medium", color: "text-[#f5a623] bg-[#f5a623]/10" },
    ...
    <Card className="border border-border/50 shadow-sm bg-white overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#4720b7]/10">
            <Layers className="h-4 w-4 text-[#4720b7]" />
          </div>
          <div>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-foreground group-hover:text-[#4720b7] transition-colors">
                    {skill.name}
                  </span>
                  <Badge
    ...
    <div className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto">
      ...
      <section>
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
          ...
          <Card className="border border-border/50 shadow-sm">
            <CardContent className="p-4 flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#4720b7]/10 shrink-0">
                <Target className="h-5 w-5 text-[#4720b7]" />
              </div>
              <div>
          ...
          <Card className="border border-border/50 shadow-sm">
            <CardContent className="p-4 flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#f5a623]/10 shrink-0">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
          <div className="relative w-full sm:max-w-sm">
            ...
            <Input
              ...
              className="pl-10 h-10 text-sm bg-white border-border/60 shadow-sm focus-visible:ring-[#4720b7]"
            />
          </div>
          <div className="flex items-center gap-2">
      ...
      <section className="pb-8">
        <Card className="border-0 bg-gradient-to-r from-[#1e2761] to-[#4720b7] shadow-lg">
