        ...
        <Card className="max-w-lg w-full">
          <CardContent className="p-8 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <UserCheck className="h-10 w-10 mx-auto mb-3" style={{ color: "rgb(71,32,183)" }} />
              ...
              <button
                ...
                className="p-6 rounded-xl border-2 border-border hover:border-primary hover:bg-primary/5 transition-all text-center"
              >
                <Users className="h-10 w-10 mx-auto mb-3" style={{ color: "rgb(71,32,183)" }} />
      ...
      <div className="min-h-screen bg-background">
        <div className="max-w-6xl mx-auto p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle className="text-sm" style={{ color: "rgb(71,32,183)" }}>
                  Teacher Controls
                </CardTitle>
              </CardHeader>
