    ...
    >
      <div className="relative w-full max-w-2xl overflow-y-auto rounded-xl bg-white p-6 shadow-xl max-h-[90vh]">
        ...
        <div className="mb-6 flex items-center gap-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#0b4f4a]/10">
            <Eye className="h-4 w-4 text-[#0b4f4a]" />
          </div>
          <div>
        ...
        {answered && (
          <Card className="border border-border/50 shadow-sm mb-6 bg-gradient-to-r from-[#0b4f4a]/5 to-transparent">
            <CardContent className="p-6">
        ...
        <div className="flex justify-end">
          <Button variant="default" onClick={onClose} className="bg-[#0b4f4a] hover:bg-[#5f6a6c]">
            Close Preview
          </Button>
        </div>
      </div>
