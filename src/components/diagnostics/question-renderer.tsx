    ...
    <EntranceAnimation key={question.id}>
      <Card>
        <CardContent className="p-6 md:p-8 space-y-6">
          ...
          {/* Passage block */}
          {question.passage && (
            <div className="rounded-lg border-l-4 border-[rgb(71,32,183)] bg-[rgb(71,32,183)]/5 p-4 text-sm leading-relaxed text-[rgb(30,39,97)]">
              <p className="font-semibold text-xs uppercase tracking-wider text-[rgb(71,32,183)] mb-2">
                Passage
              </p>
          ...
          {/* Question text */}
          <h2 className="text-lg md:text-xl font-semibold text-[rgb(30,39,97)]">
            {question.text}
          </h2>
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      // Selected state
                      isSelected && !showResults && "border-[rgb(71,32,183)] bg-[rgb(71,32,183)]/5 shadow-sm",
                      // Default state
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        ...
                        // Selected
                        isSelected && !showResults && "bg-[rgb(71,32,183)] text-white",
                        // Default
