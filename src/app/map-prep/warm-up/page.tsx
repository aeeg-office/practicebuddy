...
/* ───────── Subjects ───────── */
const SUBJECTS = [
  { key: "math", label: "Mathematics", icon: Calculator, color: "text-[#c8785a]", bg: "bg-[#c8785a]/10" },
  { key: "reading", label: "Reading", icon: BookOpen, color: "text-emerald-500", bg: "bg-emerald-500/10" },
  { key: "language-usage", label: "Language Usage", icon: Pen, color: "text-[#0b4f4a]", bg: "bg-[#0b4f4a]/10" },
]
    ...
    <div className="p-4 md:p-8 space-y-6 max-w-7xl mx-auto">
      ...
      <section>
        <div className="flex items-center gap-2 mb-4">
          <Lightbulb className="h-5 w-5 text-[#c8785a]" />
            ...
            return (
              <Card key={strategy.title} className="border border-border/60 bg-card shadow-sm hover:shadow-md transition-all duration-300">
                <CardContent className="p-5">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#c8785a]/10 text-[#c8785a] mb-3">
        ...
        {/* Tip box */}
        <div className="mt-6 rounded-xl bg-gradient-to-r from-[#c8785a]/10 to-[#0b4f4a]/10 border border-[#c8785a]/20 p-5">
          <div className="flex items-start gap-3">
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#c8785a] text-white">
