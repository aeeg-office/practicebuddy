    ...
    <div className="min-h-screen bg-[#f6f6f6]">
      ...
      <div className="bg-white border-b border-gray-200/60">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center gap-2 text-sm">
          <a href="/" className="text-[rgb(26,35,126)] hover:text-[rgb(21,27,100)] font-medium transition-colors">
            Home
          </a>
          <span className="text-gray-400">/</span>
          <a href="/practice" className="text-[rgb(26,35,126)] hover:text-[rgb(21,27,100)] font-medium transition-colors">
            Practice
          </a>
          <span className="text-gray-400">/</span>
