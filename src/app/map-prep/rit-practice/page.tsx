...
const SUBJECTS = [
  ...
  { key: "language-usage", label: "Language Usage", icon: Pen, color: "text-[#1a237e]", bg: "bg-[#1a237e]/10", href: "/map-prep/language-usage" },
]
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {SUBJECTS.map((subject) => {
            ...
            return (
              ...
              >
                <div className={`flex h-10 w-10 items-center justify-center rounded-lg ${isSelected ? `${subject.bg} ring-2 ring-[#1a237e]/10` : subject.bg}`}>
            ...
            <button
              ...
              className={`p-3 rounded-xl text-center border transition-all duration-200 ${
                selectedBand === band.label
                  ? "bg-[#1a237e] text-white shadow-md ring-2 ring-[#1a237e]/20 border-transparent"
                  : "bg-white text-foreground border-border/60 hover:border-[#1a237e]/30 hover:shadow-sm"
              }`}
            >
