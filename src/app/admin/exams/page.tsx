...
export default function ExamsPage() {
  ...
  >
    <div className="grid grid-cols-3 gap-4">
      ...
      <Card style={{ borderColor: colors.border }}><CardContent className="flex items-center gap-3 p-4"><div className="flex h-10 w-10 items-center justify-center rounded-lg bg-emerald-500/10"><BookOpen className="h-5 w-5 text-emerald-600" /></div><div><p className="text-xs text-muted-foreground">Published</p><p className="text-xl font-bold" style={{ color: colors.secondary }}>{published}</p></div></CardContent></Card>
