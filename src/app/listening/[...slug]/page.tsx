...
export default function ListeningAssessmentPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-6 space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[rgb(11,79,74)]/10">
            <Headphones className="h-5 w-5 text-[rgb(11,79,74)]" />
          </div>
          <div>
            <h1 className="text-lg font-bold text-[rgb(22,32,34)]">Listening Assessment</h1>
      ...
      <Card className="border-gray-200 overflow-hidden">
        <div
          className={`p-6 md:p-8 text-center transition-all duration-500 ${
            audioStarted ? "bg-gradient-to-b from-[rgb(11,79,74)]/5 to-transparent" : "bg-gray-50"
          }`}
        >
          {!audioStarted ? (
            <div className="space-y-4">
              <div className="flex justify-center">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-[rgb(11,79,74)]/10 animate-pulse">
                  <Headphones className="h-10 w-10 text-[rgb(11,79,74)]" />
                </div>
              </div>
              <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-center gap-1 h-16">
                {Array.from({ length: 40 }).map((_, i) => (
                  <div
                    key={i}
                    className="w-1.5 rounded-full bg-[rgb(11,79,74)] transition-all duration-300"
                    style={{
              ...
              <div className="w-full max-w-md mx-auto h-2 bg-gray-200 rounded-full overflow-hidden">
                <div
                  className="h-full rounded-full bg-gradient-to-r from-[rgb(11,79,74)] to-[rgb(200,120,90)] transition-all duration-300"
      ...
      {/* ════════════════════════════════════════ */}
      <div className="space-y-4">
        <h2 className="text-lg font-bold text-[rgb(22,32,34)] flex items-center gap-2">
          ...
          return (
            ...
            >
              <CardContent className="p-5">
                <p className="text-sm font-semibold text-[rgb(22,32,34)] mb-3">
                  {q.id}. {q.question}
                </p>
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center gap-2 p-3 rounded-lg border-2 text-left text-sm transition-all duration-200 ${
                          submitted && isThisCorrect
                            ...
                            ? "border-[rgb(11,79,74)] bg-[rgb(11,79,74)]/5 text-[rgb(22,32,34)]"
                      ...
                      >
                        ...
                        {!submitted && isSelected && (
                          <CheckCircle className="h-4 w-4 text-[rgb(11,79,74)] shrink-0" />
                        )}
                        <span>{opt}</span>
                      </button>
                    )
      ...
      {!submitted ? (
        ...
        <div className="space-y-4">
          {/* Score card */}
          <Card className="bg-gradient-to-r from-[rgb(11,79,74)]/5 to-[rgb(22,32,34)]/5 border-[rgb(11,79,74)]/20">
